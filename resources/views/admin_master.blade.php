...
<head>
    ...
    <title>@yield('title') - Foodcourt Admin</title>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="/admin" {!! $page == 'dashboard' ? 'data-active="true"' : '' !!} aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="#submenu2" {!! $page == 'master' ? 'data-active="true"' : '' !!} data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="{{ $page == 'master'?'':'collapse' }} submenu list-unstyled" id="submenu2" data-parent="#accordionExample">
                            <li {!! $page_child == 'stand' ? 'class="active"' : '' !!}>
                                <a href="/admin/stand"> Stand </a>
                            </li>
                            <li {!! $page_child == 'cashier' ? 'class="active"' : '' !!}>
                                <a href="/admin/cashier"> Kasir </a>
                            </li>
                            <li {!! $page_child == 'table' ? 'class="active"' : '' !!}>
                                <a href="/admin/table"> Meja </a>
                            </li>
                        </ul>
                    </li>

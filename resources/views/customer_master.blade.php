...
<head>
    ...
    <title>@yield('title') - Foodcourt Customer</title>
...
<body>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="/" {!! $page=='dashboard'?"data-active='true'":'' !!} aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="/neworder" {!! $page=='neworder'?"data-active='true'":'' !!} aria-expanded="false" class="dropdown-toggle">
                            <div class="">
    ...
    <script type="text/javascript">
        ...
        $(".touchMenu").change(function(){
            var l = $(".touchMenu").length;
            var total = 0;
            for (var i = 1; i <= l; i++) {
                var price = $('#menu'+i).val() * $("#menu"+i).data('price');
                $('#price'+i).text(price);
                total += price;
            }
            $('#total').text(total);
